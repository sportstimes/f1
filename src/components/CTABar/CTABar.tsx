		...
		<div className={`grid grid-col-1 md:flex pt-4 gap-3 gap-y-2`}>
			{!isInstalled &&
				<div className="h-12 grow">
					<Link href="/generate" locale={locale as any} className="bg-mid-green rounded-md shadow hover:bg-light-green hover:text-white flex justify-start content-center h-12 py-3 pl-12 relative">
						{t("options.calendar")}
			...
			{!isInstalled && config.supportsEmailReminders > 0 &&
				<div className="h-12 grow">
					<Link href="/subscribe" locale={locale as any} className="bg-mid-green rounded-md shadow hover:bg-light-green hover:text-white flex justify-start content-center h-12 py-3 pl-12 relative">
						{t("options.email")}
			...
			{config.supportsWebPush > 0 && supportsWebPush && isInstalled &&
				<div className="h-12 grow">
					<Link href="/notifications" locale={locale as any} className="bg-mid-green rounded-md shadow hover:bg-light-green hover:text-white flex justify-start content-center h-12 py-3 pl-12 relative">
						<NotificationIcon className="absolute left-3.5 self-center" />
