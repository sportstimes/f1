const Footer = () => (
  <footer className="footer">
  	...
  	<p>We’re on <a href="https://twitter.com/f1cal" className="twitter">Twitter</a> · Open Sourced on <a href="https://github.com/sportstimes/f1">GitHub</a> · A ‘KickOff’ Production · V2.0</p>
