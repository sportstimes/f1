...
import {SiteSwitcherBar} from './SiteSwitcherStyles'
import i18nConfig from "@/f1/i18n.json";
import Router from "next-translate/Router";
import SiteSwitcherLogo from './SiteSwitcherLogo';

import shared from "@/f1/db/shared.json";
...
class SiteSwitcher extends React.Component {
    ...
    render() {
        ...
        sites.map((site, index) => {
            siteItems.push(<li key={site.name}><Link href={site.url}><a><SiteSwitcherLogo site={site.siteKey}/></a></Link></li>);
        });
            ...
            <SiteSwitcherBar>
                <div className="container">
                    ...
                    <div className="social">
                        <a href="https://twitter.com/f1cal" target="_blank" rel="noopener">
...
export default withTranslation(SiteSwitcher)