...
import { SiteFooter } from './FooterStyles'
...
export default function Footer() {
    ...
    return <>
        <SiteFooter>
            ...
            <p className={`support ${lang === "ru" ? 'supportFontFallback' : ''}`}>
