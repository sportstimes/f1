...
import styles from './SupportRace.module.scss'
import withTranslation from 'next-translate/withTranslation'

class SupportRace extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            ...
            <tr key={this.props.item.slug} className={styles.race} onClick={() => this.handleRowClick()}>
                ...
                <td className={styles.dateColumn}>{moment(this.props.item.sessions.race).tz(this.props.timezone).format('D MMM')} - {moment(this.props.item.sessions.race).tz(this.props.timezone).format('D MMM')}</td>
                <td className={styles.timeColumn}></td>
                <td className={styles.badgeColumn}>
...
export default withTranslation(SupportRace)